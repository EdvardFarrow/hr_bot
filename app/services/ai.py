...
class AIService:
    ...
    async def generate_response(self, user_text: str, context: str = "", custom_system_prompt: str = None) -> str:
        """
        user_text: user message
        context: for example, the text of the resume, if it was sent earlier
        """
        current_system_prompt = custom_system_prompt if custom_system_prompt else SYSTEM_PROMPT
